...
type ISMS interface {
	send(content string, phone int64) (err error)
}
...
func (s *sms) Validate(content string) (err error) {
	if len(content) > 63 {
...
func (s *sms) Send(content string, phone int64) (err error) {
