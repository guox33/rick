...
import (
	...
	v1 "github.com/guox33/rick/grpc/start/getting-started-with-buf-cli/gen/pet/v1"
	http "net/http"
	strings "strings"
)
...
func NewPetStoreHandler(svc PetStoreHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	petStoreGetPetHandler := connect_go.NewUnaryHandler(
		PetStoreGetPetProcedure,
		svc.GetPet,
		opts...,
	)
	petStorePutPetHandler := connect_go.NewUnaryHandler(
		PetStorePutPetProcedure,
		svc.PutPet,
		opts...,
	)
	petStoreDeletePetHandler := connect_go.NewUnaryHandler(
